 ...
 * }
 * @psalm-type CookieConsentConfig = array{
 *     consent_configuration?: array{
 *         consent_cookie?: bool|array{
 *             enabled?: bool|Param, // Default: true
 *             name?: scalar|null|Param, // Set the name of the cookie // Default: "consent"
 *             http_only?: bool|Param, // Set if the cookie should be accessible only through the HTTP protocol // Default: true
 *             secure?: bool|Param, // Set if the cookie should only be transmitted over a secure HTTPS connection from the client // Default: true
 *             same_site?: "lax"|"strict"|Param, // Set the value for the SameSite attribute of the cookie // Default: "lax"
 *             domain?: mixed, // Set the value for the Domain attribute of the cookie // Default: null
 *             expires?: scalar|null|Param, // Set the value for the Expires attribute of the cookie // Default: "P180D"
 *         },
 *         consent_categories?: list<list<scalar|null|Param>>,
 *     },
 *     position?: "top"|"bottom"|"dialog"|Param, // Default: "dialog"
 *     persist_consent?: bool|Param, // Default: true
 *     form_action?: scalar|null|Param, // Default: "cookie_consent.update"
 *     read_more_route?: scalar|null|Param, // Default: null
