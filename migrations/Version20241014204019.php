...
final class Version20241014204019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cookieconsent_cookies (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, httpOnly BOOLEAN NOT NULL, secure BOOLEAN NOT NULL, sameSite VARCHAR(255) NOT NULL, expires DATETIME NOT NULL --(DC2Type:datetimetz_immutable)
